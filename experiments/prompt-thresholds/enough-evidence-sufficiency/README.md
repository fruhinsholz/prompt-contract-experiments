...
- OpenAI GPT 5.x clean run: `experiments/prompt-thresholds/results/2026-07-29T19-37-52-355Z-publication-clean-openai-gpt55-gpt56-enough-max1024-enough/`.
...
- `gpt-5.5`: 6 strong rows; active score `7.610-7.750`.
- `gpt-5.6`: 6 strong rows; active score `7.610-7.750`.
- `gemini-3.5-flash-lite`: 6 strong rows; active score `9.719-9.86`.
- `gemini-3.6-flash`: 6 strong rows; active score `7.891-8.032`.

The GPT 5.x run uses `--max-output-tokens 1024`, matching the clean LOW rerun. It has 260 raw calls, 0 invalid labels, 0 truncations, and 0 request errors.
